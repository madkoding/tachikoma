...
impl BackendClient {
    ...
    pub async fn get_all_playlists(
        &self,
    ) -> Result<Vec<Playlist>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub async fn get_playlist_with_songs(
        &self,
        id: Uuid,
    ) -> Result<Option<PlaylistWithSongs>, Box<dyn std::error::Error + Send + Sync>> {
        let url = format!("{}/playlists/{}", self.base_url, id);
        let response = self.client.get(&url).send().await?;
    ...
    pub async fn create_playlist(
        &self,
        data: CreatePlaylist,
    ) -> Result<Playlist, Box<dyn std::error::Error + Send + Sync>> {
        let url = format!("{}/playlists", self.base_url);
    ...
    pub async fn get_songs_by_playlist(
        &self,
        playlist_id: Uuid,
    ...
    pub async fn get_listening_history(
        &self,
        limit: usize,
    ) -> Result<Vec<ListeningEntry>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub async fn get_equalizer_settings(
        &self,
    ) -> Result<EqualizerSettings, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub async fn get_or_create_favorites_playlist(
        &self,
    ) -> Result<Playlist, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub async fn get_or_create_suggestions_playlist(
        &self,
    ) -> Result<Playlist, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub async fn toggle_song_like(
        ...
        // Get current song
        let song = self.get_song(id).await?.ok_or("Song not found")?;
    ...
    pub async fn update_suggestions_timestamp(
        ...
        let url = format!(
            "{}/playlists/{}/suggestions-timestamp",
    ...
    pub async fn clear_playlist_songs(
        &self,
        playlist_id: Uuid,
    ) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
