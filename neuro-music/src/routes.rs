...
pub fn create_router(state: Arc<AppState>) -> Router {
    ...
    let api_routes = Router::new()
        ...
        .route(
            "/init-special-playlists",
            post(handlers::init_special_playlists),
        )
        // Playlists
        ...
        .route(
            ...
            post(handlers::reorder_songs),
        )
        // Song likes
        .route(
            "/songs/:song_id/toggle-like",
            post(handlers::toggle_song_like),
        )
        .route(
            "/songs/:song_id/fetch-cover",
            post(handlers::fetch_song_cover),
        )
        ...
        .route(
            "/youtube/search/enriched",
            get(handlers::search_youtube_enriched),
        )
